...
class Album
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Musique", inversedBy="albums")
     */
    private $musiques;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Singer", inversedBy="albums")
     */
    private $artist;
    ...
    public function getArtist(): ?Singer
    {
        return $this->artist;
    }
